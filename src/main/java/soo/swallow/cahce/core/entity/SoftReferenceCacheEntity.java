 ...
 * @author Soo.
 */
public class SoftReferenceCacheEntity<V> extends CacheEntity<V> {
    private static final String TAG = "SoftReferenceCacheEntity--->";

    private SoftReference<V> softReference;

    public SoftReferenceCacheEntity(long period) {
        super(period);
    }
